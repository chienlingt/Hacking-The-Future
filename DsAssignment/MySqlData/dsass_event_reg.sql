...
CREATE TABLE `event_reg` (
  ...
  PRIMARY KEY (`reg_id`),
  KEY `eventreg_stu_username_idx` (`stu_username`),
  CONSTRAINT `eventreg_stu_username` FOREIGN KEY (`stu_username`) REFERENCES `user` (`Username`) ON DELETE CASCADE ON UPDATE CASCADE
