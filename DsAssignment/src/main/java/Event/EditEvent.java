...
public class EditEvent extends javax.swing.JFrame implements DocumentListener {
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                            ...
                                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                                ...
                                                .addComponent(Venue, javax.swing.GroupLayout.DEFAULT_SIZE, 167, Short.MAX_VALUE)
    ...
    private void UpdateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateButtonActionPerformed
        ...
        time = end - start;
        if(EventTitle.getText().isEmpty()||Venue.getText().isEmpty() ||jDateChooser1.getDate()==null){
    ...
    public void search(){
        ...
        try {
            ...
            if (rs.next()) {
                ...
                Time startTimeTime = rs.getTime("Start_Time");
                Time endTimeTime = rs.getTime("End_Time");
                // Extract and format the hour part
                String formattedStartTime = formatTime(startTimeTime);
                String formattedEndTime = formatTime(endTimeTime);
                StartTime.setSelectedItem(formattedStartTime);
                EndTime.setSelectedItem(formattedEndTime);
                }
             else {
                // If no record found
                clear();
