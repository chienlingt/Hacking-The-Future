    ...
    private void loginbActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginbActionPerformed
        ...
        try{
            ...
            if("null".equals(role)){
                ...
                else if (parent2 != null && !checkParentRoleExists(parent2)) {
                    deleteAccount(usernameOrEmail);
                    JOptionPane.showMessageDialog(new JFrame(), "Incorrect username or password","Error", JOptionPane.ERROR_MESSAGE);
                    Username.setText("");
                    Password.setText("");
                ...
                while(rst.next()){
                    ...
                    // password.equals(passDb)
                    
                }
                
                boolean isPasswordMatch = signup.matches(password, passDb);
                
                if(notFound == 1 && isPasswordMatch){
